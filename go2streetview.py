...
class go2streetview(gui.QgsMapTool):
    ...
    def setButtonBarSignals(self):
        ...
        self.digitizeControlWasChecked = (self.S.value("go2sv/digitizeOpt", defaultValue="true") == "true")
        self.digitizeControl.setChecked(self.digitizeControlWasChecked)
    ...
    def openSVDialog(self, show=True):
        ...
        if show:
            self.view.setWindowTitle("Google Street Merda")
